...
const AP_Param::Info var_info[] PROGMEM = {
    ...
    // @Description: Used to adjust the speed with which the target altitude is changed when objects are sensed below the blimp
    // @Range: 0.01 0.5
    // @Increment: 0.01
    // @User: Standard
    ...
    // @Description: Controls whether ArduBlimp will enter ESC calibration on the next restart.  Do not adjust this parameter manually.
    // @User: Advanced
    ...
    // @Param: LED_MODE
    // @DisplayName: Blimp LED Mode
    // @Description: bitmap to control the blimp led mode
    // @Values: 0:Disabled,1:Enable,2:GPS On,4:Aux,8:Buzzer,16:Oscillate,32:Nav Blink,64:GPS Nav Blink
    // @User: Standard
    GSCALAR(blimp_leds_mode,       "LED_MODE",         9),
...
{
    // change the default for the AHRS_GPS_GAIN for ArduBlimp
    ...
    // setup different AHRS gains for ArduBlimp than the default
    ...
    // setup different Compass learn setting for ArduBlimp than the default
    // but allow users to override in their config
