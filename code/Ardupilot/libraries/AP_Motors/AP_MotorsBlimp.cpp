...
void AP_MotorsBlimp::setup_motors()
{
    ...
    if( _frame_orientation == AP_MOTORS_BLIMP_FRAME ) {
        ...
        //Lift motor
        add_motor(AP_MOTORS_MOT_2, -90, 0, 2);


        add_motor(AP_MOTORS_MOT_3,   0, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  3);
        add_motor(AP_MOTORS_MOT_4, 180, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  4);
        ...
        add_motor(AP_MOTORS_MOT_7, 180, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  7);
        add_motor(AP_MOTORS_MOT_8, 180, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  8);
